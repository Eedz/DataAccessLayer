...
namespace ITCLib
{
    public class Cache
    {
        ...
        public DataRow RetrieveRow (int rowIndex)
        {
            ...
            {
                row = cachePages[0].table.Rows[rowIndex % RowsPerPage];
      
            }
            else if (IsRowCachedInPage(1, rowIndex))
            {
                row = cachePages[1].table.Rows[rowIndex % RowsPerPage];
        ...
        private void LoadFirstTwoPages()
        {
            ...
            new DataPage(dataSupply.SupplyPageOfData(DataPage.MapToLowerBoundary(RowsPerPage),
